...
import { abi as Reserve_TJ_gRektWavaxContract } from "src/abi/reserves/_avalanche/TJ_gRektWavax.json";
...
import { addresses, BLANK_ADDRESS, NetworkId, TokenSymbol } from "src/constants";
...
export const daiOld = new StableBond({
  name: "dai-old",
  displayName: "DAI OLD",
  bondToken: "DAI",
  payoutToken: TokenSymbol.GOHM,
  v2Bond: false,
  bondIconSvg: ["DAI"],
...
export const dai = new StableBond({
  ...
  networkAddrs: {
    [NetworkId.LOCAL]: {
      ...
      reserveAddress: addresses[NetworkId.LOCAL].DAI_ADDRESS,
    },
    [NetworkId.MAINNET]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: "0x6b175474e89094c44da98b954eedeac495271d0f",
...
export const frax = new StableBond({
  ...
  networkAddrs: {
    [NetworkId.LOCAL]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.LOCAL].FRAX_ADDRESS,
    },
    [NetworkId.MAINNET]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: "0x853d955acef822db058eb8505911ed77f175b99e",
...
export const rekt_wavax = new LPBond({
  name: "rekt_wavax_lp",
  displayName: "REKT-WAVAX LP",
  bondToken: "WAVAX",
  payoutToken: TokenSymbol.GOHM,
  v2Bond: true,
  bondIconSvg: ["OHM", "AVAX"],
  bondContractABI: BondOhmDaiContract,
  reserveContract: Reserve_TJ_gRektWavaxContract,
  isBondable: {
    [NetworkId.LOCAL]: false,
    [NetworkId.MAINNET]: false,
    [NetworkId.TESTNET_RINKEBY]: false,
  ...
  networkAddrs: {
    ...
    [NetworkId.AVALANCHE_TESTNET]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE_TESTNET].REKT_WAVAX_LP_ADDRESS,
    },
    [NetworkId.AVALANCHE]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE].REKT_WAVAX_LP_ADDRESS,
    },
  },
  lpUrl:
...
export const srekt_wavax = new LPBond({
  name: "srekt_wavax_lp",
  displayName: "sREKT-WAVAX LP",
  bondToken: "WAVAX",
  payoutToken: TokenSymbol.GOHM,
  v2Bond: true,
  ...
  networkAddrs: {
    ...
    [NetworkId.AVALANCHE_TESTNET]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE_TESTNET].SREKT_WAVAX_LP_ADDRESS,
    },
    [NetworkId.AVALANCHE]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE].SREKT_WAVAX_LP_ADDRESS,
    },
  },
  lpUrl:
...
export const grekt_wavax = new LPBond({
  name: "grekt_wavax_lp",
  displayName: "gREKT-WAVAX LP",
  bondToken: "WAVAX",
  payoutToken: TokenSymbol.GOHM,
  v2Bond: true,
  ...
  networkAddrs: {
    ...
    [NetworkId.AVALANCHE_TESTNET]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE_TESTNET].GREKT_WAVAX_LP_ADDRESS,
    },
    [NetworkId.AVALANCHE]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: addresses[NetworkId.AVALANCHE].GREKT_WAVAX_LP_ADDRESS,
    },
  },
  lpUrl:
...
export const ohm_dai = new LPBond({
  ...
  networkAddrs: {
    [NetworkId.LOCAL]: {
      bondAddress: BLANK_ADDRESS,
      reserveAddress: BLANK_ADDRESS, // TODO: create this
    },
    [NetworkId.MAINNET]: {
